...
const FavoritesPage: React.FC = () => {
  ...
  useEffect(() => {
    const filteredFavorites = mockData.filter(recipe => favorites.includes(recipe.title));
  ...
  return (
    <Row className="my-5 mx-8 sm:mx-16 dark:bg-black">
      <Header />
      <RecipeList favorites={favorites} filteredData={favoriteRecipes} handleCardClick={handleCardClick} toggleFavorite={toggleFavorite} />
      {selectedRecipe && (
